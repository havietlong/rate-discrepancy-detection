...
st.set_page_config(page_title="Hotel Operations Tool", page_icon="🔍", layout="wide")
st.title("🏨 Hotel Operations Tool")
...
def debug_parse_rates(comment_text, target_date):
    ...
    return {
        ...
        'has_adjustment': result[2].get('has_adjustment', False),
...
with st.sidebar:
    ...
    st.divider()
    st.caption("v4.6 - Hotel Operations Tool - Work in progress - Exporting Difference")
...
if uploaded_file:
    ...
    if app_mode == "🔍 Rate Discrepancy Scanner":
        ...
        with st.spinner("Processing PDF for rate discrepancies..."):
                        ...
                        with col_override1:
                            if st.button("🔴 Mark as NEED FIX"):
                                ...
                                st.session_state.training_data[room_data['override_key']] = {
                                    ...
                                    'comment_text': room_data['debug_comment_text'][:500],
            ...
            if st.session_state.training_data:
                ...
                with st.expander("ℹ️ How training data works"):
                    ...
                    **When you click a Manual Override button, the following is saved:**
                    ...
                    | Rate Source | How the scanner found the rate |
                    | Original Decision | What the scanner thought |
    ...
    if app_mode == "🔍 Rate Discrepancy Scanner":
        st.info("👈 Please upload a night audit PDF to check for rate discrepancies")
        st.markdown("""
        ### 🔍 Rate Discrepancy Scanner
        - Upload your night audit PDF
        - Detects rate mismatches between comments and system
